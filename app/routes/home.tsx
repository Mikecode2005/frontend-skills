...
export async function action({ request, context }: Route.ActionArgs) {
  ...
  } else if (intent === "delete-agent") {
    const agentId = Number(form.get("agentId"));
    if (Number.isInteger(agentId)) await agents.delete(agentId);
